...
class _ShoppingCartScreenState extends State<ShoppingCartScreen> {
                              ...
                              children: [
                                Container(
                                    ...
                                    child: CachedNetworkImage(
                                      imageUrl:
                                          "http://struggling-capacity.000webhostapp.com/parentingland/images/productimages/${cartList[index]['imagename']}.jpg",
                                      fit: BoxFit.cover,
  ...
  void _loadCart() {
    http.post(
        "http://struggling-capacity.000webhostapp.com/parentingland/php/load_cart.php",
        body: {
  ...
  void _deleteCart(int index) {
    http.post(
        "http://struggling-capacity.000webhostapp.com/parentingland/php/delete_cart.php",
        body: {
          "email": widget.user.email,
          "foodid": cartList[index]['foodid'],
        }).then((res) {
